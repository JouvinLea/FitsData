...
# ./make_index_file.py "Crab_All.list" "ash_north_stereo" "Prod15_4_stereo"
#./make_index_file.py "Crab_4runs.list" "test_ash_stereo_thsq64_psftable" "Prod15_4_stereo"
# ./make_index_file.py "Crab_40runs.list" "ash_stereo_thsq64" "Prod15_4_stereo"

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Make the index and obs table')
    parser.add_argument('runlist', action="store",
                        help='List of run for which we want to define the index and obs table')
    ...
    observation_list = ListObservations(runlist, config)
    obs_table(observation_list, directory + "/" + prod + "/" + config, "old", "obs-index.fits.gz")
    file_table(observation_list, directory + "/" + prod + "/" + config, "old", "hdu-index.fits.gz")
    # Pour Lyon
    # obs_table(observation_list, directory+"/data/hess/hap-16-03_fits/"+prod+"/"+config, "old", "obs-index.fits.gz" )
    # file_table(observation_list, directory+"/data/hess/hap-16-03_fits/"+prod+"/"+config, "old", "hdu-index.fits.gz" )
