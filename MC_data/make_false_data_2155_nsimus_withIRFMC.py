...
#./make_false_data_2155_nsimus_withIRFMC.py "ash_stereo_thsq64" "Prod15_4_stereo" 200 "PWL" 2
#./make_false_data_2155_nsimus_withIRFMC.py "ash_stereo_thsq64" "Prod15_4_stereo" 200 "PWL" 2.2
#./make_false_data_2155_nsimus_withIRFMC.py "ash_stereo_thsq64" "Prod15_4_stereo" 200 "EXP" 2.3 0.2
#./make_false_data_2155_nsimus_withIRFMC.py "ash_stereo_thsq64" "Prod15_4_stereo" 200 "EXP" 2 0.2
#./make_false_data_2155_nsimus_withIRFMC.py "ash_stereo_thsq64" "Prod15_4_stereo" 200 "EXP" 2.1 0.2
...
if __name__ == '__main__':
    ...
    for ns in range(Nsimus):
        ...
        if loi_spectrale=="PWL":
            outdir=indir_MC+"/MC_simus/gamma_"+str(gamma_input)+"_flux_"+str(percent_flux_Crab_simulated.value)+"Crab_withIRFMC/Nsimus_"+str(ns)
            outdir2=indir_MC+"/MC_simus/gamma_"+str(gamma_input)+"_flux_"+str(percent_flux_Crab_simulated.value)+"Crab_withIRFMC/Nsimus_"+str(ns)+"/"+str(RealObservation.folder())
        elif loi_spectrale=="EXP":
            outdir=indir_MC+"/MC_simus/gamma_"+str(gamma_input)+"_beta_"+str(beta_input)+"_flux_"+str(percent_flux_Crab_simulated.value)+"Crab_withIRFMC/Nsimus_"+str(ns)
            outdir2=indir_MC+"/MC_simus/gamma_"+str(gamma_input)+"_beta_"+str(beta_input)+"_flux_"+str(percent_flux_Crab_simulated.value)+"Crab_withIRFMC/Nsimus_"+str(ns)+"/"+str(RealObservation.folder())
        try:
            os.makedirs(outdir2)
        except Exception:
            pass
