...
#./make_false_data_2155_nsimus.py "ash_stereo_thsq64" "Prod15_4_stereo" 150
...
if __name__ == '__main__':    
    ...
    for ns in range(Nsimus):
        ...
        outdir=indir_MC+"/MC_simus/gamma_"+str(gammaMC)+"_flux_"+str(percent_flux_Crab_simulated.value)+"Crab/Nsimus_"+str(ns)
        outdir2=indir_MC+"/MC_simus/gamma_"+str(gammaMC)+"_flux_"+str(percent_flux_Crab_simulated.value)+"Crab/Nsimus_"+str(ns)+"/"+str(RealObservation.folder())
